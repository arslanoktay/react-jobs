...
const JobPage = ({ deleteJob }) => {
  ...
  // const { id } = useParams(); // url den id gibi bilgileri çekmek için kullanılıyor
  ...
  //             setJob(data);
  //         } catch (error) {
  //             console.log('Error job fetcing data', error)
  //         } finally {
  //             setLoading(false);
  //         }
  //     }
  ...
  const onDeleteClick = (jobId) => {
    const confirm = window.confirm('Are you sure you want to delete his listing?')
